...
<video width="100%" height="100%" style="position:absolute" controls>
  <source src="https://files.chiloh.net/blog/chatgpt-vercel.mp4" type="video/mp4">
</video>
</div>
...
![NPM Host](https://files.chiloh.net/blog/npm-host.png "NPM Host")
...
![NPM SSL](https://files.chiloh.net/blog/npm-ssl.png "NPM SSL")

最后，就可以使用你自己的域名访问网站了。部署后的效果如图：

![ChatGPT Web](https://files.chiloh.net/blog/chatweb.png "ChatGPT Web")
